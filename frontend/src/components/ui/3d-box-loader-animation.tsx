const ColorfulLoader = () => {
  const loaderCss = `
    .loader {
      ...
      --primary-light: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);
      --primary-rgba: rgba(102, 126, 234, 0);
      width: 200px;
      height: 320px;
      position: relative;
    ...
    .loader:before, .loader:after {
      ...
      right: 32%;
      bottom: -11px;
      /* Updated background to match a light theme */
      background: #ffffff; 
    ...
    .loader .ground div {
      ...
      width: 200px;
      height: 200px;
      background: linear-gradient(45deg, #ff9a9e 0%, #fecfef 50%, #fecfef 50%, #ffd1ff 100%);
      transform-style: preserve-3d;
    ...
    .loader .ground div:before, .loader .ground div:after {
      ...
      height: 300px;
      opacity: 0;
      background: linear-gradient(to bottom, rgba(255, 154, 158, 0.8), rgba(255, 154, 158, 0));
      position: absolute;
    ...
    .loader .ground div:after {
      ...
      --y: 177px;
      --z: 150px;
      background: linear-gradient(to bottom, rgba(254, 207, 239, 0.8), rgba(254, 207, 239, 0));
    }
    ...
    /* Colorful box variations */
    .loader .box.box0 div { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); }
    .loader .box.box1 div { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); }
    .loader .box.box2 div { background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); }
    .loader .box.box3 div { background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); }
    .loader .box.box4 div { background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); }
    .loader .box.box5 div { background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); }
    .loader .box.box6 div { background: linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%); }
    .loader .box.box7 div { background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%); }
    ...
    @keyframes ground-shine { 0%, 70% { opacity: 0; } 75%, 87% { opacity: 0.3; } 100% { opacity: 0; } }
